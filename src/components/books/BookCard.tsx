...
const BookCard = ({ book, variant = "default" }: BookCardProps) => {
  if (variant === "featured") {
    return (
      <div className="group relative h-full min-h-[500px] bg-secondary overflow-hidden">
        <img
          src={book.coverImage}
          alt={book.title}
  ...
  if (variant === "compact") {
    return (
      <div className="group flex gap-4 p-4 border border-border hover:bg-secondary/50 transition-colors duration-300 h-full">
  ...
  if (variant === "horizontal") {
    return (
      <div className="group flex flex-col sm:flex-row gap-6 p-6 border border-border hover:bg-secondary/50 transition-colors duration-300">
        <div className="w-full sm:w-32 h-48 sm:h-44 bg-secondary flex-shrink-0 overflow-hidden">
          <img
            src={book.coverImage}
            alt={book.title}
            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
